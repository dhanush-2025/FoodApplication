                    ...
                    FAuth.createUserWithEmailAndPassword(emailid,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                databaseReference = FirebaseDatabase.getInstance().getReference("Restaurent").child(useridd);
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        hashMap1.put("Rest name",fname);
                                        hashMap1.put("Owner",lname);
                                        ...
                                        firebaseDatabase.getInstance().getReference("Restaurent")
...
//
    ...
    public boolean isValid(){
        ...
        isValid = (isValidconfpassword && isValidpassword  && isValidemail && isValidmobilenum && isValidname &&  isValidlname&&isEmailVerified) ? true : false;
        return isValid;
